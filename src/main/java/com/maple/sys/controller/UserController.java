...
import com.maple.sys.common.*;
import com.maple.sys.entity.Role;
import com.maple.sys.entity.User;
import com.maple.sys.service.IRoleService;
import com.maple.sys.service.IUserService;
import com.maple.sys.vo.UserVo;
...
/**
 * <p>
 * InnoDB free: 9216 kB; (`deptid`) REFER `BaseStationMis/sys_dept`(`id`) ON UPDATE CASC 前端控制器
 * </p>
 *
 * @author wdf
 * @since 2019-11-21
...
public class UserController {
    ...
    public DataGridView loadAllUser(UserVo userVo){
        ...
        queryWrapper.like(StringUtils.isNotBlank(userVo.getCompany()),"company",userVo.getCompany());
        //查询系统用户
    ...
    public ResultObj updateUserInfo(UserVo userVo){
        try {
            //用户头像不是默认图片
            if (!(userVo.getImgpath()!=null&&userVo.getImgpath().equals(Constast.DEFAULT_IMG_MATERIALS))){
