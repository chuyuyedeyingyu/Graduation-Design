...
public class AppFileUtils {
     ...
     * @return
     */
    public static String renameFile(String materialsImg) {
        File file = new File(UPLOAD_PATH,materialsImg);
        String replace = materialsImg.replace("_temp","");
        if (file.exists()){
    ...
    public static void removeFileByPath(String oldPath) {
        //图片的路径不是默认图片的路径
        if (!oldPath.equals(Constast.DEFAULT_IMG_MATERIALS)){
